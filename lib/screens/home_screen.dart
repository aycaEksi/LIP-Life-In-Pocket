...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _parseAvatarData(String dataString) {
    try {
      ...
      final eyeColorMatch = RegExp(r"eyeColor: (#[0-9a-fA-F]{6})").firstMatch(dataString);
      final bottomMatch = RegExp(r"bottom: ([\w-]+|null)").firstMatch(dataString);
      final bottomColorMatch = RegExp(r"bottomColor: (#[0-9a-fA-F]{6})").firstMatch(dataString);
      final topMatch = RegExp(r"top: ([\w-]+|null)").firstMatch(dataString);
      final topColorMatch = RegExp(r"topColor: (#[0-9a-fA-F]{6})").firstMatch(dataString);
      ...
      _avatarData = {
        ...
        'bottom': bottomMatch?.group(1) != 'null' ? bottomMatch?.group(1) : null,
              ...
              Center(
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    final availableSize = math.min(size.width - 48, size.height - 200);
                    ...
                    return SizedBox(
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          // Çevreleyen Butonlar
                          ..._buildCircularButtons(context, colorScheme, containerSize, buttonSize, radius),
                        ],
                      ),
                    );
                  },
      ...
      _CircularButton(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => ProfileScreen(themeManager: widget.themeManager),
            ),
          );
        },
      ),
